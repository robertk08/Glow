...
nonisolated struct ChannelRange: Decodable, Hashable, Sendable, Identifiable {
...
nonisolated struct FixtureProfile: Decodable, Hashable, Sendable, Identifiable {
	...
	init(id: String, manufacturer: String = "", model: String, mode: String = "", channels: [ProfileChannel], symbol: String = "lightbulb", panDegrees: Double? = nil, tiltDegrees: Double? = nil) {
		self.id = id
